...
/**
 * STUB - Settings destination for the Learn tab's layout pickers
 * (cover-screen variant + Flex Mode/tabletop variant). Reached from
 * [SettingsHubFragment]'s "Learn layout" row.
 *
 * See [TranslateLayoutSettingsFragment]'s doc comment for the shape a later
 * phase should build here - same pattern, just
 * `SettingsTab.LEARN` instead of `SettingsTab.TRANSLATE`. This file is this
 * phase's to edit freely; nothing else depends on its internals.
 */
class LearnLayoutSettingsFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return TextView(requireContext()).apply {
            text = "Learn layout settings — coming soon."
